/**
 * Core Intelligence Hooks Index (v3.7.2)
 * Phase 2-3 hooks: Tactical, Attachment, Chronotype, Behavioral Economics, etc.
 */
...
export type { CampaignChain, TriggerCondition, TriggerCampaignType, ActionCampaignType } from '../useCampaignOrchestrator';
