...
export const AIConfirmationDialog = forwardRef<HTMLDivElement, AIConfirmationDialogProps>(
  ({ state, onConfirm, onCancel }, ref) => {
...
AIConfirmationDialog.displayName = 'AIConfirmationDialog';
