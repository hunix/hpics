/**
 * ContextualRecommendations - AI-generated suggestions based on current context
 */
...
export function ContextualRecommendations({ className, maxItems = 5 }: ContextualRecommendationsProps) {
  ...
  const { recommendations, currentContext, getRecommendations } = useContextEngine();
      ...
      <CardContent>
        {displayRecommendations.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p className="text-xs">Suggestions appear based on your context</p>
            <Button 
              variant="outline" 
              size="sm" 
              className="mt-3"
