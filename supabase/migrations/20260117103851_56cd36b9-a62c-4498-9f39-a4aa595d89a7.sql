-- Drop ALL existing versions of search_contacts_v3 (all 3 overloads)
DROP FUNCTION IF EXISTS public.search_contacts_v3(uuid, text, text, text, text, boolean, character, text, text, integer, integer);
...
-- Create ONE canonical version with correct parameter order
